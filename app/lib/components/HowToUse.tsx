    ...
    return (
        <div className="flex flex-col justify-center">
            ...
            <p>
                ...
                must match. An example of this is the word "mind" rhyming with
                "blind".
            </p>
            ...
            <p>
                ...
                "palms are sweaty" rhymes with "arms are heavy". In addition,
                multiple text decorations indicate that a word or phrase
                contains more than one rhyme pair. The text decorations used
                are: bold, italics, red text, underline, and strikethrough.
            </p>
        </div>
    );
};
